...
import { Search, Wallet, Contact, User } from "lucide-react";
      ...
      {items.map(({ href, label, icon: Icon }) => {
        ...
        return (
          <Link
            ...
            href={href}
            className={cn(
              "flex flex-col items-center justify-center rounded-full px-4 py-2 transition-transform active:scale-90",
              active
